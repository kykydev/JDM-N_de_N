...
Généré par `src/corpus_check.py` sur `data/corpus/raw/`. Rien n'a été supprimé ni modifié dans `data/corpus/raw/` : ce rapport signale, les décisions restent manuelles.
...
| corpus_r_has_causatif | 71 | 0 | 0 | 9 |
...
| corpus_r_processus_patient | 80 | 0 | 0 | 0 |
| corpus_r_product_of | 80 | 0 | 0 | 0 |
